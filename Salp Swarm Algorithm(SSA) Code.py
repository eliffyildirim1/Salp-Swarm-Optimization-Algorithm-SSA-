...
# SSA Function
def salp_swarm_algorithm(problem, swarm_size = 5, min_values = [-5,-5], max_values = [5,5], iterations = 200000, target_function = target_function):
    count    = 0
    ...
    #print(best_cost, best_solution_pos)
